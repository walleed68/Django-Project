...
MIDDLEWARE = [
    ...
    'Admin.LoginCheckMiddleWare.LoginCheckMiddleWare'
]
...
TEMPLATES = [
    {
        ...
        'DIRS': ['Admin/templates','Teacher/templates','Student/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#AUTHENTICATION_BACKENDS = ['Admin.EmailBackEnd.EmailBackEnd']
